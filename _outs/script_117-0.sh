...
python /lfs/l1/legend/users/dandrea/pygama/pygama-optimizer/optimizer.py -r 117 -c 0 -g -p -f -t -d /lfs/l1/legend/users/dandrea/pygama/pygama-optimizer > /lfs/l1/legend/users/dandrea/pygama/pygama-optimizer/_outs/optimizer_117_0.out
