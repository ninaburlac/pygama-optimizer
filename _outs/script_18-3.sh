...
python /lfs/l1/legend/users/dandrea/pygama/pygama-optimizer/optimizer.py -r 18 -c 3 -g -p -f -t -d /lfs/l1/legend/users/dandrea/pygama/pygama-optimizer > /lfs/l1/legend/users/dandrea/pygama/pygama-optimizer/_outs/optimizer_18_3.out
