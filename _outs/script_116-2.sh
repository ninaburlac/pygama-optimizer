...
python /lfs/l1/legend/users/dandrea/pygama/pygama-optimizer/optimizer.py -r 116 -c 2 -g -p -f -t -d /lfs/l1/legend/users/dandrea/pygama/pygama-optimizer > /lfs/l1/legend/users/dandrea/pygama/pygama-optimizer/_outs/optimizer_116_2.out
